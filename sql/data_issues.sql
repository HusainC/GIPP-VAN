...
SELECT DISTINCT
      ...
      ,P.INSURERTENURE
      ,P.APR
      ,R.PROPOSERPOLICYHOLDER_INSTALMENTSREQUESTEDIND AS "INSTALMENTS"
      ,P.DEPOSIT
      ,P.EXISTINGCUSTOMER
      ,P.USERROLE
      ,P.MTACOUNT
...
INNER JOIN "PRD_RAW_DB"."QUOTES_PUBLIC"."VW_POLARIS_VEH_REQ" R
    ON B.NB_SUBMISSION = R.QUOTE_REFERENCE
;
...
AND nvl(D.DRIVER_PRN,1)=1
INNER JOIN "PRD_RAW_DB"."QUOTES_PUBLIC"."VW_POLARIS_VEH_REQ" R
    ON B.RN_SUBMISSION = R.QUOTE_REFERENCE
;
...
,g.nb_date_created as nb_date_created
      ...
      --,case when P.DEPOSIT, 0 = v.DEPOSIT, 0  then 0 else 1 end as DEPOSIT
